...
| ISSUE-001-T02 | Simplify credit wording and refund messaging | done | yes | `npm run check` passed; UI/README copy now uses simple credit wording and refund reassurance. | Backend ledger terms remain internal. |
