...
| L020 | Configure, deploy, and verify the live payment MVP | done | yes | Retained providers extended; additive migrations, magic-link auth, deployment, test/live exactly-once purchases, and purchased-credit cohort use verified. |

Next ready task: none.

Provider continuity: the existing lofi Supabase, Render, `cohort15.com`, Resend/email, analytics, domain, and production data were retained and extended through `docs/human-tasks/piece-of-pie-launch.md`.
