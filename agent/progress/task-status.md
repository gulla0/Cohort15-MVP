...
| L002 | Add isolated lofi persistence and Supabase migration | not_started | yes | Pending |
| L003 | Build anonymous cohort creation | not_started | no | Pending |
| L004 | Build the landing page, listing, and lifecycle views | not_started | no | Pending |
| L005 | Build anonymous interest and quorum unlock | not_started | no | Pending |
