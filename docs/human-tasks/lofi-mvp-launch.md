...
4. Open `SQL Editor` -> `New query`, then run these migration files in filename order:
   - `supabase/migrations/20260618000000_cohort15_lofi.sql` from the repository root
   - `supabase/migrations/20260618000001_fix_cohort15_lofi_accept_interest.sql` from the repository root
