...
export function renderHomePage({
  ...
  return `<!doctype html><html lang="en"><head>${analyticsMarkup(googleAnalyticsId)}<meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="Cohort15 helps people form small, high-intent online groups around shared goals."><title>Cohort15 | Small, high-intent online groups</title><link rel="stylesheet" href="/assets/styles.css"></head><body>
    <header class="shell topbar"><a class="brand" href="/">Cohort15</a><nav class="site-nav" aria-label="Primary navigation"><a class="text-link" href="#cohorts">Browse cohorts</a><a class="text-link" href="/research">Research &amp; Field Notes</a>${renderAuthNavigation(auth)}</nav></header>
    ...
    <footer><div class="shell">Cohort15 — small, high-intent online groups.</div></footer>${renderFeedbackWidget()}${localTimeScript()}</body></html>`;
}
